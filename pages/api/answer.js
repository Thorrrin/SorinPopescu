...
const SYSTEM_PROMPTS = {
	...
	COMEDIAN: {
		MESSAGE: {
			'role': 'system',
			'content': 'You are a comedian! Your goal is to make the user laugh. Knock knock...',
		},
		TEMPERATURE: 1,
		MAX_TOKENS: 100,
		TYPE: 'comedian',
...
const converse = (res, messages, type) => {
	switch (type) {
		...
		case SYSTEM_PROMPTS.COMEDIAN.TYPE:
			return converseChat(res, messages, SYSTEM_PROMPTS.COMEDIAN);
		default:
